...
public class RequestLogFilter extends OncePerRequestFilter {
    ...
    public void logRequestStart(HttpServletRequest request){
        ...
        if(id != null) {
            ...
            Map<String, Object> detailMap = (Map<String, Object>) SecurityContextHolder.getContext().getAuthentication().getDetails();
             Account user=userMapper.findById((Integer) detailMap.get("userId"));
            log.info("请求URL: \"{}\" ({}) | 远程IP地址: {} │ 身份: {} (UID: {}) | 角色: {} | 请求参数列表: {}",
                    request.getServletPath(), request.getMethod(), request.getRemoteAddr(),
                    user.getUsername(), id, user.getRole(), object);
        } else {
